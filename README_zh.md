...
`tools/dataset_tools/` 提供数据准备与划分工具：

- `create_empty_labels.py` — 为无标注图片生成空 YOLO 标签文件
- `split_images_only/` — 仅划分图片
- `split_train_val/` — 同时划分图片与标签
- `split_train_val_test/` — 三分划分（train/val/test）
