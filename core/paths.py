"""Shared model registry and download URL helpers.

Repo-specific path constants belong in each repo's entry point, not here.
"""
...
def get_model_download_url(filename: str, tag_key: str) -> str:
    """Return the GitHub download URL for a pretrained model."""
